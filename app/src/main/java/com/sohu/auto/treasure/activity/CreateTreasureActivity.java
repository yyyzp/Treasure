...
public class CreateTreasureActivity extends RxAppCompatActivity implements AMap.OnMyLocationChangeListener {
    ...
    private void initListener() {
        btnCreate.setOnClickListener(v -> {
            ...
            markerList.add(MarkerDrawer.drawMarker(CreateTreasureActivity.this, aMap, latLng));
        });
    }
